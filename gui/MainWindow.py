...
class Ui_Form(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setFont(font)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("calibre-cloud-plugin/images/icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
...
"border-radius: 1px;")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("calibre-cloud-plugin/images/yandex_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
...
"border-radius: 1px;")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("calibre-cloud-plugin/images/google_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
...
"border-radius: 1px;")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("calibre-cloud-plugin/images/license_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
...
"border-radius: 1px;")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("calibre-cloud-plugin/images/question_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
